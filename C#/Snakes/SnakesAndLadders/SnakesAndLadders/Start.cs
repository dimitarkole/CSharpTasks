...
namespace SnakesAndLadders
{
    public partial class Start : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (player2 == "")
            {
                MessageBox.Show("Моля поставете име на играч 2!", "Змии и стълби");
                flag = 1;
            }
            if ((rbtnTree.Checked == true)||(rbtnFour.Checked==true))
            {
                if (player3 == "")
                {
                    MessageBox.Show("Моля поставете име на играч 3!", "Змии и стълби");
                    flag = 1;
                }
                if(rbtnFour.Checked==true)
                {
                    if (player4 == "")
                    {
                        MessageBox.Show("Моля поставете име на играч 4!", "Змии и стълби");
                        flag = 1;
                    }
                }
